...
class Detail extends PureComponent {
  ...
  render() {
    ...
    const { detail:{ listLoading, data: { title, content, author, replies }}} = this.props
    console.log(author)
    return (
        ...
        <Row gutter={16}>
                ...
                <div className={styles.panel}>
                  ...
                  <div className={styles.inner}>
                    <div className={styles.topic_content}>
                      <div className={styles.markdown_text} dangerouslySetInnerHTML={{ __html: content }} />
                    </div>
                  </div>
                </div>
          ...
          <Col span={5}>
            <div className={styles.sidebar}>
              ...
              <div className={styles.panel}>
                <div className={styles.sidebar_inner}>
                  <a href="https://www.aliyun.com/product/nodejs?ref=cnode" target="_blank" rel='noreferrer noopener'
                     class="banner sponsor_outlink" data-label="alinode">
