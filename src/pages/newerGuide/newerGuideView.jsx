            ...
            <div className={styles.content}>
              <div className={styles.header}>
                <Breadcrumb>
                  ...
                  <Breadcrumb.Item style={{color: '#999'}}>Node.js新手入门</Breadcrumb.Item>
                </Breadcrumb>
              </div>
              <div className="text">
                <h2>Node.js 入门</h2>
                ...
                <p>
                  <a href="http://nodeweekly.com/issues" target="_blank" rel="noopener noreferrer">
                ...
                <p>
                  <a href="https://github.com/pana/node-books" target="_blank" rel="noopener noreferrer"
                  >
